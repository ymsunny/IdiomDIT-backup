...
# -*- coding: utf-8 -*-
"""
clean_fr_en.py — 清洗 Fr→En 习语数据集

原始数据：nightingal3/idiom-translation
  metaphor-translation/data/test_sets_final/fr/idiomatic_all.csv

输出 schema 与 En_Fa.csv / Fa-En.csv 一致：
  idiom, sentence, gold translation

用法：
  python scripts/clean_fr_en.py --input <path_or_url> --output Data/Fr-En-Idiom/ParallelData/Fr_En_clean.csv
"""
...
DEFAULT_OUTPUT = os.path.join(
    ...
    "Data", "Fr-En-Idiom", "ParallelData", "Fr_En_clean.csv"
)
...
def main():
    parser = argparse.ArgumentParser(description="清洗 Fr→En 习语数据集")
