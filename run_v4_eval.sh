...
#
# 用法:
#   bash run_v4_eval.sh [MODEL] [lang1 lang2 ...]
#   JUDGES="gpt-5.2" bash run_v4_eval.sh Qwen3-8B en-fa fa-en ...        # 只跑某评委
#   JUDGES="gpt-5.2 gpt-4o-mini" ...                                     # 自定义顺序/集合
#
# 评委顺序/集合由 JUDGES 控制（空格分隔；默认 "gpt-5.2 gpt-4o-mini"）。
# 顺序：外层评委、内层方向 → 默认会先把所有方向的 gpt-5.2 跑完，再跑 gpt-4o-mini。
...
LANGS=("$@"); [ ${#LANGS[@]} -eq 0 ] && LANGS=(en-fa fa-en ja-en ko-en)
JUDGES_STR=${JUDGES:-"gpt-5.2 gpt-4o-mini"}
